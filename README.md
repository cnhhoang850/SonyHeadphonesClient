...
**Running on Linux:** Enable executable properties for the script, either by right click > permission > Allow executing as program, or running 
```sudo chmod +x ./SonyHeadphonesClient```
